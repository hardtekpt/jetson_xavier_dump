...
class inspectStrategy: public followingStrategyBaseClass{
    ...
    ros::Publisher vis_pub_ref;

    public:
        inspectStrategy(DroneLib::UAV * _uav, std::vector<double> _kp,  std::vector<double> _ki,  std::vector<double> _kd);
